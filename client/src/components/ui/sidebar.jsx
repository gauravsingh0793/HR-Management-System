...
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => {
  return (
    (<div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden group-data-[collapsible=icon]:overflow-hidden scrollbar-thin scrollbar-track-transparent scrollbar-thumb-slate-200 hover:scrollbar-thumb-slate-300",
        className
      )}
      {...props} />)
  );
